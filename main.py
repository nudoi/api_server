...
@app.get("/api/v1/latest_24h")
def read_latest_24h_data():
...
@app.get("/api/v1/start_date={start_date}")
def read_data(start_date: str):
...
@app.get("/api/v1/start_date={start_date}/end_date={end_date}")
def read_data(start_date: str, end_date: str):
